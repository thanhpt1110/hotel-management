...
{
    public partial class FormMessageBoxThongBao : Form
    {
        //Fields
        ...
        //Event Methods
        private void FormMessageBoxThongBao_Paint(object sender, PaintEventArgs e)
        {
            //-> SMOOTH OUTER BORDER
        ...
        private void FormMessageBoxThongBao_Resize(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormMessageBoxThongBao_SizeChanged(object sender, EventArgs e)
        {
            this.Invalidate();
        }

        private void FormMessageBoxThongBao_Activated(object sender, EventArgs e)
        {
            this.Invalidate();
        }
